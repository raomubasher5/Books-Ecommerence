...
const AdminDashboard = () => {
    const {user ,   getAllProducts , getAllOrder , getAllUser} = useMyContext();
    return (
        <Layout>
            <div className='pt-12'>
                {/* Top */}
                            ...
                            <TabList className="flex flex-wrap -m-4 text-center justify-center">
                                ...
                                <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                    <div className=" border  hover:bg-blue-gray-100 border-blue-gray-100 px-4 py-3 rounded-xl" >
                                        ...
                                        <h2 className="title-font font-medium text-3xl text-blue-gray-400 fonts1" >{getAllProducts.length}</h2>
                                        <p className=" text-blue-gray-500  font-bold" >Total Products</p>
                                    </div>
                                </Tab>
                                ...
                                <Tab className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                                    <div className=" border  hover:bg-blue-gray-100 border-blue-gray-100 px-4 py-3 rounded-xl" >
                                        ...
                                        <h2 className="title-font font-medium text-3xl text-blue-gray-400 fonts1" >{getAllOrder.length}</h2>
                                        <p className=" text-blue-gray-500  font-bold" >Total Order</p>
                                    </div>
                                </Tab>
